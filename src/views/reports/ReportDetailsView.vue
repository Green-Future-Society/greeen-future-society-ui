    ...
    <div class="flex flex-col min-h-screen lg:ml-64">
      ...
      <main class="flex-1 p-4 sm:p-6">
        ...
        <template v-else-if="reportsStore.currentReport">
          ...
          <!-- Media Section -->
          <div v-if="reportsStore.currentReport.media && reportsStore.currentReport.media.length > 0" class="mt-6 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100">
              <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                <svg class="w-5 h-5 mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                Media ({{ reportsStore.currentReport.media.length }})
              </h2>
            </div>
            <div class="p-6">
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div
                  v-for="media in reportsStore.currentReport.media"
                  :key="media.id"
                ...
                >
                  ...
                  >
                    <img
                      ...
                      loading="lazy"
                    />
                    <div class="absolute bottom-2 left-2 px-2 py-1 bg-black/50 text-white text-xs rounded">
                      Image
                    </div>
                  </a>
                  <!-- Video -->
